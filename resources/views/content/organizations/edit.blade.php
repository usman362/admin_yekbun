...
@section('title', 'Organizations - Edit')
...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Organizations /</span> Edit Organization
</h4>
<div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('donations.organizations.update', $organization->id) }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                          ...
                          <input type="text" id="inputName" name="name" class="form-control" value="{{ old('name')?? $organization->name }}" placeholder="Organization Name">
                          @error('name')
                        ...
                        <div class="col-md-12">
                          ...
                          <input type="text" id="inputBankAccount" name="bank_account" class="form-control" value="{{ old('bank_account')?? $organization->bank_account }}" placeholder="Bank Account">
                          @error('bank_account')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                          @enderror
                        </div>
                        <div class="col-md-12">
                          ...
                          <input type="text" id="inputPaypalAccount" name="paypal_account" class="form-control" value="{{ old('paypal_account')?? $organization->paypal_account }}" placeholder="Paypal Account">
                        ...
                        <div class="col-md-12">
                          ...
                          <input type="text" id="inputAddress" name="address" class="form-control" value="{{ old('address')?? $organization->address }}" placeholder="Address">
                          @error('address')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                          @enderror
                        </div>
