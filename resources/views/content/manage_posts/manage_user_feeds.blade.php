...
@section('content')
                            ...
                            @if ($feed)
                                <div class="col-md-3">
                                    <div class="post-image">
                                        ...
                                        <div id="feed-post-{{ $feed->id }}" class="card is-post mt-4 p-1 mb-0 view-post card-post" data-fancybox="post1" data-lightbox-type="comments" data-id="{{ $feed->_id }}">
                ...
                <div id="main-feed" class="container main-feed">
                    <div class="row g-4">
                        @foreach ($reportscomments as $reportcomments)
                            ...
                            <div class="col-md-3">
                                <div class="post-image">
                                    <div id="feed-card-{{ $feed->id }}" class="card is-post mt-4 p-1 mb-0 view-post card-post" data-fancybox="post1" data-lightbox-type="comments" data-id="{{ $feed->_id }}">
                                        <div class="content-wrap">
                                            <div class="card-footer pb-2 pt-0 mt-0 pl-0 pr-0">
                                                <div class="user-block">
                                                    <div class="user-info">
    ...
    <!-- Modal for Reported Feeds and Latest Feeds -->
