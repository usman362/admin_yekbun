                                ...
                                <div class="post-image">
                                    <a data-fancybox="post1" data-lightbox-type="comments">
                                        <video controls="" class="videoclass w-100">
                                            <source
                                                src="http://127.0.0.1:2002/storage/videos/67decf78071b7___SampleVideo_1280x720_1mb.mp4">
                                        </video>
                                    </a>
                                    <!-- Action buttons -->

                                </div>
                                {{-- <small>SampleVideo_1280x720_1mb.mp4</small>&nbsp;&nbsp;
                                <small>0 Views</small> --}}
                            </div>
                                    ...
                                    <div class="user-info">
                                        <div class="row">
                                            <div class="col-md-2 p-0">
                                                <img src="http://127.0.0.1:2002/storage/music/67df34d5b5524___men-avatar.png"
                                                    style="width: 100%">
                                            </div>
                                            <div class="col-md-10">
                                                <div class="mt-2">
                                                    <div class="d-flex" style="line-height: 0;">
                                                        <p><b>Toyota yaris convert into yaris</b></p>
                                                        <span style="color: black !important;position: absolute;right: 18px;">
                                                            <i class="fas fa-ellipsis-vertical"></i>
                                                        </span>
                                                    </div>
                                                    <p class="m-0">Piston passion</p>
                                                    <small class="time"><i>0 views . &nbsp;&nbsp;1 day ago</i></small>
                                                </div>
