                        ...
                        <div class="col-lg-8 mx-auto">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="fullname" class="form-control" placeholder="lorem" name="first_name" value="{{ $artist->first_name ?? '' }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="fullname">Last Name</label>
                                    <input type="text" id="fullname" class="form-control" placeholder="lorem" name="last_name" value="{{ $artist->last_name ?? '' }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" id="fullname" class="form-control" name="dob" value="{{ $artist->dob ?? '' }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset('storage/'.$artist->image) }}" height="150">
                                </div>
