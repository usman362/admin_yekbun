                                            ...
                                            <div class="form-check custom-option custom-option-icon checked">
                                                <label class="form-check-label custom-option-content"
                                                    ...
                                                    <input name="plUserType" class="form-check-input" type="radio"
                                                        value="1" id="customRadioBuilder" checked="">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md mb-md-0 mb-2">
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content"
                                                    ...
                                                    <span class="custom-option-body">
                                                        ...
                                                        <small>Submit property as an Individual. Lease, Rent or Sell at the
                                                            best price.</small>
                                                    </span>
                                                    <input name="plUserType" class="form-check-input" type="radio"
                                            ...
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content"
                                                    ...
                                                    <span class="custom-option-body">
                                                        ...
                                                        <small>Earn highest commission by listing your clients properties at
                                                            the best price.</small>
                                                    </span>
                                                    <input name="plUserType" class="form-check-input" type="radio"
                        ...
                        <div id="property-details" class="content fv-plugins-bootstrap5 fv-plugins-framework">
                            <div class="row g-3">
                                            ...
                                            <div class="form-check custom-option custom-option-icon checked">
                                                <label class="form-check-label custom-option-content"
                                                    ...
                                                    <span class="custom-option-body">
                                                        ...
                                                        <small>Post your property for sale.<br> Unlimited free
                                                            listing.</small>
                                                    </span>
                                                    <input name="plPropertySaleRent" class="form-check-input"
                                                        type="radio" value="1" id="customRadioSell"
                                                        checked="">
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content"
                                                    ...
                                                    <span class="custom-option-body">
                                                        ...
                                                        <small>Post your property for rent.<br> Unlimited free
                                                            listing.</small>
                                                    </span>
                                                    <input name="plPropertySaleRent" class="form-check-input"
                                                        type="radio" value="2" id="customRadioRent">
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 fv-plugins-icon-container">
                                    ...
                                    <div class="position-relative"><select id="plPropertyType" name="plPropertyType"
                                            class="select2 form-select select2-hidden-accessible" data-allow-clear="true"
                                            data-select2-id="plPropertyType" tabindex="-1" aria-hidden="true">
                                            ...
                                            dir="ltr" data-select2-id="3" style="width: auto;"><span
                                                class="selection"><span
                                                    ...
                                                    aria-disabled="false"
                                                    aria-labelledby="select2-plPropertyType-container"><span
                                                        class="select2-selection__rendered"
                                                        id="select2-plPropertyType-container" role="textbox"
                                                        aria-readonly="true"><span
                                                            class="select2-selection__placeholder">Select property
                                                            type</span></span><span class="select2-selection__arrow"
                                                        role="presentation"><b
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="position-relative"><select id="plCountry" name="plCountry"
                                            class="select2 form-select select2-hidden-accessible" data-allow-clear="true"
                                            data-select2-id="plCountry" tabindex="-1" aria-hidden="true">
                                            ...
                                            dir="ltr" data-select2-id="1" style="width: auto;"><span
                                                class="selection"><span
                                                    ...
                                                    aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                    aria-disabled="false"
                                                    aria-labelledby="select2-plCountry-container"><span
                                                        class="select2-selection__rendered"
                                                        id="select2-plCountry-container" role="textbox"
                                                        aria-readonly="true"><span
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="plFurnishedStatus" name="plFurnishedStatus" class="form-select">
                                        <option selected="" disabled="" value="">Select furnished status
                                        </option>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <tags class="tagify  form-control" tabindex="-1">
                                        <tag title="Fridge" contenteditable="false" spellcheck="false" tabindex="-1"
                                            class="tagify__tag tagify--noAnim" value="Fridge">
                                            <x title="" class="tagify__tag__removeBtn" role="button"
                                                aria-label="remove tag"></x>
                                            <div><span class="tagify__tag-text">Fridge</span></div>
                                        </tag>
                                        <tag title="AC" contenteditable="false" spellcheck="false" tabindex="-1"
                                            class="tagify__tag tagify--noAnim" value="AC">
                                            <x title="" class="tagify__tag__removeBtn" role="button"
                                                aria-label="remove tag"></x>
                                            <div><span class="tagify__tag-text">AC</span></div>
                                        </tag>
                                        <tag title="TV" contenteditable="false" spellcheck="false" tabindex="-1"
                                            class="tagify__tag tagify--noAnim" value="TV">
                                            <x title="" class="tagify__tag__removeBtn" role="button"
                                                aria-label="remove tag"></x>
                                            <div><span class="tagify__tag-text">TV</span></div>
                                        </tag>
                                        <tag title="WiFi" contenteditable="false" spellcheck="false" tabindex="-1"
                                            class="tagify__tag tagify--noAnim" value="WiFi">
                                            <x title="" class="tagify__tag__removeBtn" role="button"
                                                aria-label="remove tag"></x>
                                            <div><span class="tagify__tag-text">WiFi</span></div>
                                        </tag><span contenteditable="" tabindex="0" data-placeholder="select options"
                                            aria-placeholder="select options" class="tagify__input" role="textbox"
                                            aria-autocomplete="both" aria-multiline="false"></span>
                                        ​
                                    </tags><input id="plFurnishingDetails" name="plFurnishingDetails"
                                        class="form-control" placeholder="select options" value="Fridge, AC, TV, WiFi"
                                        tabindex="-1">
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" id="plAvailableFrom" name="plAvailableFrom"
                                        class="form-control flatpickr flatpickr-input" placeholder="YYYY-MM-DD"
                                        readonly="readonly">
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="number" class="form-control" id="plOtherAmount"
                                            name="plOtherAmount" placeholder="500" aria-describedby="pl-other-amount">
                                ...
                                <div class="col-md-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="plOtherCharges"
                                            id="plOtherCharges">
                                        <label class="form-check-label" for="plOtherCharges">Stamp Duty &amp; Registration
