                ...
                <div class="col-md-2">
                    <div class="post-image" style="position: relative;">
                        <div id="feed-post-1"
                             class="card-post"
                             data-fancybox
                             data-src="#template-popup-{{ $key }}"
                             href="javascript:;"
                             data-thumb="{{ asset('storage/' . $clip->thumbnail) }}"
                             data-id="{{ $clip->id }}"
                             data-demo-href="{{ asset('storage/' . $clip->thumbnail) }}">

                            {{-- Full Video / Lottie Area --}}
                            <div class="card-body p-0" style="height: 335px; width: 100%;">
                            ...
                            <div class="hover-info">
                                <div style="display: flex; justify-content: space-between; align-items: start;">
                                    ...
                                    <!-- Dropdown (Settings) -->
                                    <div class="nav-item dropdown d-block" onclick="event.stopPropagation();" style="position: relative;">
