...
<style>
    ...
    .card-post:hover .hover-price-info {
    opacity: 1 !important;
        ...
        <div class="view-wrapper">
            <div id="main-feed" class="container main-feed">
                                ...
                                <div class="content-wrap p-2" style="position: relative; height: 100%;">
                                    ...
                                    <div class="hover-info">
                                        <div style="display: flex; justify-content: space-between; align-items: start;">
                                            ...
                                            <!-- Settings Dropdown -->
                                            <div class="nav-item dropdown d-block" style="position: absolute; right: 16px; top: 20px;">
                                                ...
                                                <div class="dropdown-menu text-center dropdown-menu-end"
                                                    ...
                                                    <form action="{{ route('delete.clipsTemplate', $clip->id) }}"
                                                        onsubmit="confirmAction(event, () => event.target.submit(), '{{ $message }}')" method="post"
                                                        class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                    ...
                                    <div class="hover-price-info"
                                        style="position: absolute; bottom: 6px; left: 0; width: 100%; display: flex; justify-content: center; gap: 16px; opacity: 0; pointer-events: none; transition: opacity 0.3s;">

                                        <!-- Educated Price -->
                                        <div style="background-color: rgb(0 0 0 / 30%);
                border-radius: 8px;
                ...
                justify-content: center;">
                                            <img src="{{ asset('assets/svg/svg-dialog/educated.svg') }}" width="15" alt="">
                ...
                align-items: center;
                justify-content: center;">
                                            <img src="{{ asset('assets/svg/svg-dialog/cultivated.svg') }}" width="15" alt="">
                                            <span class="text-white ms-1">
                                                {{ $clip->cultivated_price == 'free' ? 'Free' : '0,99 €' }}
                                            </span>
                                        </div>
                                    </div>
