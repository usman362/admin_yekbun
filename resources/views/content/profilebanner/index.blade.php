...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Users </span> /Add Profile Banner
    </h4>


    <ul class="nav nav-pills flex-column flex-md-row mb-3 d-flex justify-content-end align-item-end">

        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createcategoryModal">Add Banner</button>
    </ul>
    <!--/ User Sidebar -->
    ...
    <x-modal id="createcategoryModal" title="Add Background" saveBtnText="Add" saveBtnType="submit" saveBtnForm="createForm"
        ...
        @include('content.include.profilebanner.createForm')
    </x-modal>
    <!-- /Modal -->
@endsection
