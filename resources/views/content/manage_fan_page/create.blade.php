      ...
      <div class="card">
        <div id="sticky-wrapper" class="sticky-wrapper" style="height: 86.9375px;"><div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
          ...
          <div class="action-btns">
            <a href="{{ route('manage-fanpage.index') }}">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="row g-3">
                <div class="col-md-6">
                  <form method="POST" action="{{ route('manage-fanpage.store') }}">
                    @csrf
                  <label class="form-label" for="fullname">User Name</label>
                  <input type="text" id="fullname" class="form-control" placeholder="Lorem" name="user_name">
                  @error('user_name')
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" id="fullname" class="form-control" placeholder="Lorem" name="fanpage_name">
                  @error('fanpage_name')
                  <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
