...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('history-category.update',$history_category->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="fullname" class="form-control" placeholder="Jang" name="history_category" value="{{ $history_category->name ?? '' }}">
