...
<!--  margin: auto;margin-top:20px;">-->
        ...
        <!--                         <object style="height:80px;width:80px;margin:auto;display:flex;" data="{{ asset('assets/img/four4.png') }}" data-original3="{{ asset('assets/img/four4.png') }}" data-default3="{{ asset('assets/img/--><!--fourdef2.png') }}" width="80" height="80" class="carousel-inner imagechangefour" data-contentfour2new="#imagecontentfour1new"></object>-->
        <!--                    </div>-->
        ...
        <!--                         <object style="height:80px;width:80px;margin:auto;display:flex;" data="{{ asset('assets/img/four4(4).png') }}" data-original3="{{ asset('assets/img/four4(4).png') }}" data-default3="{{ asset('assets/img/--><!--fourdef1.png') }}" width="80" height="80" class="carousel-inner imagechangefour"  data-contentfour2new="#imagecontentfour2"></object>-->
            ...
            <div style="margin-left:5px;margin-top:20px;" class="row pick-content d-flex justify-content-around">
                ...
                <div style="width:33.3%" class="carousel-inner brchg imagepicker ">
                    ...
                    <object style="height:80px;width:80px;margin:auto;display:flex;"
                        data="{{ asset('assets/img/four4.png') }}"
                        data-original3="{{ asset('assets/img/four4.png') }}"
                        data-default3="{{ asset('assets/img/
                        fourdef2.png') }}" width="80" height="80"
                        class="carousel-inner videochangefour" data-contentfour2="#videocontentfour1"></object>
                </div>
                ...
                <div style="width:33.3%" class="carousel-inner brchg imagepicker ">
                    ...
                    <object style="height:80px;width:80px;margin:auto;display:flex;"
                        ...
                        data-original3="{{ asset('assets/img/four4(4).png') }}"
                        data-default3="{{ asset('assets/img/
                        fourdef1.png') }}" width="80" height="80"
                        class="carousel-inner videochangefour" data-contentfour2="#videocontentfour2"></object>
