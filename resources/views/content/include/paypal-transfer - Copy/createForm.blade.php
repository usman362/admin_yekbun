...
<form id="createForm" method="POST" action="{{ route('settings.paypal.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-lg-12 mx-auto">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" id="inputTitle" class="form-control" placeholder="Paypal Client Id" name="paypal_cleint_id">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" id="inputTitle" class="form-control" placeholder="Paypal Client Secret" name="paypal_cleint_secret">
