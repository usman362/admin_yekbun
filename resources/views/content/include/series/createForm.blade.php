            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="card">
                                <h5 class="card-header">Upload Series</h5>
                                <div class="card-body">
                                    <div class="dropzone needsclick" action="/" id="dropzone-series">
                                        <div class="dz-message needsclick">
                                            Drop files here or click to upload
                                        </div>
                                        <div class="fallback">
                                            <input type="file" name="series[]"  accept="video/*" id="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    dropZoneInitFunctions.push(function (){
            ...
            const dropzoneMulti = new Dropzone('#dropzone-series', {
                ...
                success: function (file, response) {
                    ...
                    hiddenInputsContainer.innerHTML += `<input type="hidden" name="series[]" value="${response.path}" data-path="${response.path}">`;
