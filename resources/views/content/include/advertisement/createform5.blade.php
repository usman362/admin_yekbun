...
" rel="stylesheet">
<form id=createForm method="POST" action="{{ route('specialads.store') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-lg-12 mx-auto">
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <br>
                    <input class="form-control" style="width:100%;" placeholder="Food Cards Title" name="card_name">
