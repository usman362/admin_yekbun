...
" rel="stylesheet">
<form id=createForm method="POST" action="{{ route('list.business.store') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-lg-12 mx-auto">
            <div class="row g-3">
              ...
              <div class="col-md-12">
                ...
                <br>
                <input class="form-control" style="width:100%;"  placeholder="Business Cards Title" name="card_name">
         ...
         <div class="col-12">
                  <div class="card">
                    ...
                    <div class="card-body p-0">
                        ...
                        <input type="file" name="card_image" class="dropify" data-default-file="{{ old('card_image', $image ?? '') }}">
