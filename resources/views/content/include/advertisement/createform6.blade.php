...
" rel="stylesheet">
<form id=createForm method="POST" action="{{ route('list.business.store.ads') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-lg-12 mx-auto">
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <br>
                    <input class="form-control" style="width:100%;" placeholder="Business Title" name="card_name">
