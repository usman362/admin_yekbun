...
@section('content')
                        ...
                        <div class="content-wrap">
                            ...
                            <div class="card-heading justify-content-between">
                                ...
                                <div class="d-flex justify-content-end align-item-end">
                                    <form action="{{ route('business.ads.delete',$card->id) }}" onsubmit="confirmAction(event, () => event.target.submit())" method="post" class="d-inline">
                                        @method('DELETE')
                                        @csrf
    ...
    <x-modal id="createcategoryModal" title="Add Background" saveBtnText="Add" saveBtnType="submit" saveBtnForm="createForm"
        ...
        @include('content.include.advertisement.createForm6')
    </x-modal>
    <!-- /Modal -->
    <script>
