...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Advertisment </span> / Food & Drinks Cards
    </h4>
                        ...
                        <div class="content-wrap">
                            ...
                            <div class="card-heading justify-content-between">
                                ...
                                <div class="d-flex justify-content-end align-item-end">
                                    <form action="{{ route('food.ads.delete',$card->id) }}" onsubmit="confirmAction(event, () => event.target.submit())" method="post" class="d-inline">
                                        @method('DELETE')
                                        @csrf
    ...
    <x-modal id="createcategoryModal" title="Add Background" saveBtnText="Add" saveBtnType="submit" saveBtnForm="createForm"
        ...
        @include('content.include.advertisement.createform8')
    </x-modal>
    <!-- /Modal -->
    <script>
