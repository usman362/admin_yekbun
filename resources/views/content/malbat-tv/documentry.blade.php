...
@section('title', 'MalbatkTV Documentary')
    ...
    <div class="d-flex justify-content-between">
        <div>
            <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">MalbatTV /</span> Documentary
            </h4>
        </div>
        <div class="">
...
<form action="{{ route('malbatDocumentry.destroy', $video->_id) }}"
    ...
    <x-modal id="createvideoModal" title="Add New Documentary" subtitle="MP4 or AVI" saveBtnText="Create Video" saveBtnType="submit"
        ...
        @include('content.include.malbat_documentry.createForm', ['form' => 'createvideoForm'])
    </x-modal>
