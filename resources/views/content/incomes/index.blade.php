                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th style="font-size: 16px ">Order</th>
                                <th style="font-size: 16px ">Date & Time</th>
                                <th style="font-size: 16px ">About User</th>
                                <th style="font-size: 16px ">Service Type</th>
                                <th style="font-size: 16px ">Payment Type</th>
                                <th style="font-size: 16px ">Total Paid</th>
