...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Block Fan Page /</span> Block Fan Page
</h4>
</div>
<div class="">
    <a href="{{ route('block-fanpage.create') }}">
                ...
                <div class="dropdown d-inline-block show">
                  ...
                  <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl dropdown-menu"
                    ...
                    <ul class="nav flex-column">
                      <li class="nav-item">
                        <a href="{{ route('blockfanpage-status',['id'=>$page->id,'status'=>0]) }}"
                          class="nav-link">Pending
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="{{ route('blockfanpage-status',['id'=>$page->id,'status'=>1]) }}"
                          class="nav-link">Active
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="{{ route('blockfanpage-status',['id'=>$page->id,'status'=>2]) }}"
                          class="nav-link">DeActive
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="{{ route('blockfanpage-status',['id'=>$page->id,'status'=>3]) }}"
              ...
              <td>
                <div class="dropdown d-inline-block">
                  ...
                  <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl dropdown-menu" style="min-width: 9rem;">
                    <ul class="nav flex-column">
                      <li class="nav-item">
                        <a href="{{ route('block-fanpage.edit',$page->id) }}" class="nav-link">
                      ...
                      <li class="nav-item">
                        <a href="javascript:void(0);" class="nav-link" type="button" onclick="delete_service(this);"
                          data-id="{{ route('block-fanpage.destroy',$page->id) }}">
