...
@section('content')
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body pb-0">
                            <div class="m-auto text-center">
                                <span class="badge bg-label-primary p-2"><i class='bx bx-male'
                ...
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body pb-0">
                            <div class="m-auto text-center">
                                <span class="badge bg-label-info p-2"><i class='bx bx-female'
                                        style="font-size:70px;"></i></span>
                            </div>
    ...
    <div class="row">
        ...
        <!-- Expense Overview -->
        <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4">
            <div class="wrapper pt-1" style="background-color:white;padding-bottom: 12px;">
                <div class="card-100" style="margin: 30px;">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                        <div><i class="fa-solid fa-chart-pie"></i> My Storage</div>
                    </div>
                    <div class="traffic-time" style="display:flex;justify-content:center">
                        <div>
                ...
                <div class="mystorage mt-2" style="padding-left: 20px; background-color: white;">
                    <div class="card-body pt-2">
                        <div class="fw-bold">2.2 GB used</div>
                        <div class="text-muted">25% used – 3.8GB Free</div>
                        <div class="progress" style="height: 12px;margin-bottom:10px;margin-top:10px">
                            <div class="progress-bar bg-info" style="width:25%;"><b>25%</b></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6 order-3 order-lg-4 mb-4 mb-lg-0">
            <div class="card text-center">
                    ...
                    <ul class="nav nav-pills" role="tablist">
                        <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                                ...
                                aria-selected="true">Andriod</button>
                        </li>
                        <li class="nav-item">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-pills-os" aria-controls="navs-pills-os"
                                aria-selected="false">IOS</button>
                        </li>

                    </ul>
                </div>
                @php
                    $andriodusers = App\Models\User::where('device_type', 'android')->get();
                @endphp
                ...
                <div class="tab-content pt-0">
                    ...
                    @php
                        $aiosusers = App\Models\User::where('device_type', 'ios')->get();
                    @endphp
