                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="dashboard-card">
                            ...
                            <img src="images/logout_icon.png" class="img-fluid logout_icon" alt="">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
...
">Total APIs: &nbsp; &nbsp; <span class="text-success"> 21 </span>
                            ...
                            <div class="col-md-6">
                                <div class="dashboard-card p-2">
                                    <div class="row">
                                        <div class="col-md-6 text-center border-end">
                                            <img src="{{ asset('assets/img/lock_img.png') }}" class="img-fluid w-85 m-auto d-flex" alt="">
                                            <h3 class="mb-0 " style="font-size: 15px;">OTP Status </h3>
                                            <div class="mb-0">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <h2 class="mb-0" style="font-size: 15px;">Options</h2>
                                            <div class="mb-3">
                                                <h3 style="font-size: 14px;">Status &nbsp; &nbsp; <span class="text-success"> ON </span></h3>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center">
                         ...
                         <div class="dashboard-card">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/img/img_profile.png') }}" class="img-fluid rounded-circle " style="width: 50px;" alt="">
