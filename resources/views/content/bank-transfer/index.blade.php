...
@section('content')
    ...
    <div class="card mb-4"> <!-- First Card: Bank Transfer List -->
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="m-0"style="font-size: 24px;"><strong>Bank Transfer List</strong></h5>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th style="font-size: 15px;">Owner Name</th>
                            <th style="font-size: 15px;">Account No</th>
                            <th style="font-size: 15px;">IBAN No</th>
