...
<div class="card">
  <div class="card-header d-flex align-items-center justify-content-between">
    <h5 class="m-0" style="font-size: 24px;"> <strong>GooglePay List</strong></h5>
    ...
    <table class="table">
      <thead>
        <tr>
          ...
          <th style="font-size: 15px;">GooglePay Client Id</th>
          <th style="font-size: 15px;">GooglePay Client Secret </th>
            ...
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    <tr>
                        ...
                        <td class="line-height-1">
                            <p class="m-0"><strong>GooglePay</strong></p>
                                ...
                                <form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="payment-method">
                                            ...
                                            <option value="Bank Transfer">GooglePay</option>
