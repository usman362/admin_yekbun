                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 ">
                                    <div class="bordered">
                                        ...
                                        <input @if($avatar->sharing_option == "1") checked @endif  type="radio" id="cul_users" name="sharing_options" value="1" checked="checked" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="bordered">
                                    	...
                                    	<input @if($avatar->sharing_option == "2") checked @endif  type="radio" id="educated_users" name="sharing_options" value="2"  />
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                	<div class="bordered">
