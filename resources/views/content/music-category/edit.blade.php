        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <div class="row g-3">
                <div class="col-md-12">
                  <form method="POST" action="{{ route('music-category.update',$music_category->id) }}" enctype="multipart/form-data">
                    @csrf
                  @method('put')
                  <label class="form-label" for="fullname">News Category</label>
                  <input type="text" id="fullname" class="form-control" placeholder="Jang" name="music_category" value="{{ $music_category->name ?? '' }}">
