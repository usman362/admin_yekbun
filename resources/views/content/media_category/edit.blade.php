        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <div class="row g-3">
                <div class="col-md-12">
                  <form method="POST" action="{{ route('media-category.update',$media_category->id) }}" enctype="multipart/form-data">
                    @csrf
                  @method('put')
                  <label class="form-label" for="fullname">Vote Category</label>
                  <input type="text" id="fullname" class="form-control" placeholder="Jang" name="media_category" value="{{ $media_category->name ?? '' }}">
                  @error('vote_category')
