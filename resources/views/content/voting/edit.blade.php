...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div id="sticky-wrapper" class="sticky-wrapper" style="height: 86.9375px;">
                <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                    ...
                    <div class="action-btns">
                        <a href="{{ route('vote.index' ,$vote->id) }}" class="nav-link">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('vote.update',$vote->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" name="description" style="height:150px;">{{ $vote->description ?? '' }}</textarea>
                                </div>
