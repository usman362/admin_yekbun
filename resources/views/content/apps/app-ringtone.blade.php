                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            ...
                                            <form
                                                action="{{ route('settings.appsetting.ringtone.destroy', $ringtone->id) }}"
                ...
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class=" w-100">
                                <h4 class="modal-title" id="modalCenterTitle">Create Ringtone</h4>
                            </div>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form id="createForm" method="POST" action="{{ route('settings.appsetting.ringtone.store') }}"
