                                ...
                                <div class="user-avatar-section">
                                    <div class=" d-flex align-items-center flex-column">
                                        <img style="border-radius: 100%;width:50px" class="img-fluid my-2 profile-img"
                                            ...
                                            alt="{{ $friend->user->name . ' ' . $friend->user->last_name }}">
                                        <div class="user-info text-center">
                                            <p class="mb-2">
                                                <b>{{ $friend->user->name . ' ' . $friend->user->last_name }}</b>
                                            </p>
                                            <p class="m-0" style="font-size: 12px;font-weight:bold"><img style="height:12px;width:12px"
                                            ...
                                            <span style="font-size: 12px">{{ $friend->user->user_id }}</span>
                                        </div>
