...
@section('vendor-style')
    ...
    <link rel="stylesheet"
        href="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/vendor/libs/mapbox-gl/mapbox-gl.css" />
@endsection
...
<head>
    ...
    <!-- Page Styles -->
    <link rel="stylesheet"
        href="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/vendor/css/pages/app-logistics-fleet.css" />
...
@section('content')
                ...
                <div class="d-flex app-logistics-fleet-wrapper" style="height: 600px !important;">
                    ...
                    <div class="flex-shrink-0 position-fixed m-4 d-md-none w-auto zindex-1">
                        <button class="btn btn-label-white border border-2 zindex-2 p-2" data-bs-toggle="sidebar"
                            data-overlay="" data-target="#app-logistics-fleet-sidebar"><i class="bx bx-menu"></i></button>
                    </div>
                    ...
                    <div class="app-logistics-fleet-sidebar col h-100" id="app-logistics-fleet-sidebar">
                        ...
                        <div class="card-body p-0 logistics-fleet-sidebar-body ps ps--active-y">
                            ...
                            <div class="accordion p-2" id="fleet" data-bs-toggle="sidebar" data-overlay=""
                                ...
                                <div class="accordion-item shadow-none border-0 mb-0" id="fl-1">
                                    <div class="accordion-header" id="fleetOne">
                                        <div role="button" class="accordion-button shadow-none collapsed"
                                            ...
                                            <ul class="timeline ps-3 mt-4">
                                                ...
                                                <li class="timeline-item ps-4 border-transparent">
                                                    ...
                                                    <div class="timeline-event ps-0 pb-0">
                                                        <div class="timeline-header">
                                                            <small
                                                                class="text-primary text-uppercase fw-medium">arriving</small>
                                                        </div>
                                                        <h6 class="mb-1">Veronica Herman</h6>
                                ...
                                <div class="accordion-item shadow-none border-0 mb-0" id="fl-2">
                                    <div class="accordion-header" id="fleetTwo">
                                        <div role="button" class="accordion-button shadow-none collapsed"
                                            data-bs-toggle="collapse" data-bs-target="#fleet2" aria-expanded="false"
                                            ...
                                            <ul class="timeline ps-3 mt-4">
                                                ...
                                                <li class="timeline-item ps-4 border-transparent">
                                                    ...
                                                    <div class="timeline-event ps-0 pb-0">
                                                        <div class="timeline-header">
                                                            <small
                                                                class="text-primary text-uppercase fw-medium">arrived</small>
                                                        </div>
                                                        <h6 class="mb-1">Myrtle Ullrich</h6>
                                                        <p class="text-muted mb-0">Sep 04, 8:18 AM</p>
                                                    </div>
                                ...
                                <div class="accordion-item shadow-none border-0 mb-0 active" id="fl-3">
                                    <div class="accordion-header" id="fleetThree">
                                        <div role="button" class="accordion-button shadow-none"
                                            data-bs-toggle="collapse" data-bs-target="#fleet3" aria-expanded="true"
                                    ...
                                    <div id="fleet3" class="accordion-collapse collapse show" data-bs-parent="#fleet"
                                        style="">
                                        <div class="accordion-body pt-3 pb-0">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <h6 class="mb-1">Delivery Process</h6>
                                            ...
                                            <ul class="timeline ps-3 mt-4">
                                                ...
                                                <li class="timeline-item ps-4 border-transparent">
                                                    ...
                                                    <div class="timeline-event ps-0 pb-0">
                                                        <div class="timeline-header">
                                                            <small
                                                                class="text-secondary text-uppercase fw-medium">arriving</small>
                                                        </div>
                                                        <h6 class="mb-1">Barry Schowalter</h6>
                                                        <p class="text-muted mb-0">Sep 04, 8:18 AM</p>
                                                    </div>
                                ...
                                <div class="accordion-item shadow-none border-0 mb-0" id="fl-4">
                                    <div class="accordion-header" id="fleetFour">
                                        <div role="button" class="accordion-button collapsed shadow-none"
                                            data-bs-toggle="collapse" data-bs-target="#fleet4" aria-expanded="false"
                            ...
                            <div class="ps__rail-y" style="top: 0px; height: 611px; right: 0px;">
                        ...
                        <div id="map" class="w-100 h-100 mapboxgl-map">
                            ...
                            <div
                                ...
                                <canvas class="mapboxgl-canvas" tabindex="0" aria-label="Map" role="region"
                                    width="1584" height="298" style="width: 792px; height: 149px;"></canvas>
                                <div class="marker mapboxgl-marker mapboxgl-marker-anchor-center" aria-label="Map marker"
                                    style="width: 20px; height: 42px; cursor: pointer; transform: translate(-2540px, 996px) translate(-50%, -50%) translate(0px, 0px);">
                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/illustrations/fleet-car.png"
                                        alt="Fleet Car" width="20" class="rounded-3 marker-focus" id="carFleet-1">
                                </div>
                                <div class="marker mapboxgl-marker mapboxgl-marker-anchor-center" aria-label="Map marker"
                                    style="width: 20px; height: 42px; cursor: pointer; transform: translate(-5427px, 442px) translate(-50%, -50%) translate(0px, 0px);">
                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/illustrations/fleet-car.png"
                                        alt="Fleet Car" width="20" class="rounded-3" id="carFleet-2">
                                </div>
                                <div class="marker mapboxgl-marker mapboxgl-marker-anchor-center" aria-label="Map marker"
                                    style="width: 20px; height: 42px; cursor: pointer; transform: translate(396px, 75px) translate(-50%, -50%) translate(0px, 0px);">
                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/illustrations/fleet-car.png"
                                        alt="Fleet Car" width="20" class="rounded-3 marker-focus" id="carFleet-3">
                                </div>
                                <div class="marker mapboxgl-marker mapboxgl-marker-anchor-center" aria-label="Map marker"
                                    style="width: 20px; height: 42px; cursor: pointer; transform: translate(-5660px, 2165px) translate(-50%, -50%) translate(0px, 0px);">
                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/illustrations/fleet-car.png"
                                        alt="Fleet Car" width="20" class="rounded-3" id="carFleet-4">
                                </div>
                            </div>
                                ...
                                <div class="mapboxgl-ctrl-bottom-right">
                                    <div class="mapboxgl-ctrl mapboxgl-ctrl-attrib"><button
                                        ...
                                        <div class="mapboxgl-ctrl-attrib-inner" role="list"><a
                                                ...
                                                href="https://apps.mapbox.com/feedback/?owner=mapbox&amp;id=light-v9&amp;access_token=pk.eyJ1IjoibG9yZC1zaGl2YW0iLCJhIjoiY2xpeTlpNHFwMDVzbDNmczl2MXdob29udyJ9.JOLDU6VQG_ra1CoVG4jbUA#/-73.967524/40.759984/16"
                                                target="_blank" aria-label="Map feedback" rel="noopener nofollow">Improve
                                                this map</a></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                class="mapboxgl-canvas-container mapboxgl-interactive mapboxgl-touch-drag-pan mapboxgl-touch-zoom-rotate">
                                <canvas class="mapboxgl-canvas" tabindex="0" aria-label="Map" role="region"
                                    width="335" height="539" style="width: 372.552px; height: 600px;"></canvas>
                                <div class="marker mapboxgl-marker mapboxgl-marker-anchor-center" aria-label="Map marker"
                                    style="width: 20px; height: 42px; cursor: pointer; transform: translate(144px, 272px) translate(-50%, -50%) translate(0px, 0px);">
                                    <img src="https://dash.yekbun.net/assets/img/illustrations/fleet-car.png"
                                        alt="Fleet Car" width="20" class="rounded-3" id="carFleet-1"></div>
                                <div class="marker mapboxgl-marker mapboxgl-marker-anchor-center" aria-label="Map marker"
                                    style="width: 20px; height: 42px; cursor: pointer; transform: translate(-27px, 239px) translate(-50%, -50%) translate(0px, 0px);">
                                    <img src="https://dash.yekbun.net/assets/img/illustrations/fleet-car.png"
                                        alt="Fleet Car" width="20" class="rounded-3" id="carFleet-2"></div>
                                <div class="marker mapboxgl-marker mapboxgl-marker-anchor-center" aria-label="Map marker"
                                    style="width: 20px; height: 42px; cursor: pointer; transform: translate(317px, 218px) translate(-50%, -50%) translate(0px, 0px);">
                                    <img src="https://dash.yekbun.net/assets/img/illustrations/fleet-car.png"
                                        alt="Fleet Car" width="20" class="rounded-3" id="carFleet-3"></div>
                                <div class="marker mapboxgl-marker mapboxgl-marker-anchor-center" aria-label="Map marker"
                                    style="width: 20px; height: 42px; cursor: pointer; transform: translate(-40px, 341px) translate(-50%, -50%) translate(0px, 0px);">
                                    <img src="https://dash.yekbun.net/assets/img/illustrations/fleet-car.png"
                                        alt="Fleet Car" width="20" class="rounded-3" id="carFleet-4"></div>
                            </div>
                                ...
                                <div class="mapboxgl-ctrl-bottom-right">
                                    <div class="mapboxgl-ctrl mapboxgl-ctrl-attrib mapboxgl-compact"><button
                                        ...
                                        <div class="mapboxgl-ctrl-attrib-inner" role="list"><a
                                                ...
                                                title="OpenStreetMap" aria-label="OpenStreetMap">© OpenStreetMap</a> <a
                                                class="mapbox-improve-map"
                                                href="https://apps.mapbox.com/feedback/?owner=mapbox&amp;id=light-v9&amp;access_token=pk.eyJ1IjoibG9yZC1zaGl2YW0iLCJhIjoiY2xpeTlpNHFwMDVzbDNmczl2MXdob29udyJ9.JOLDU6VQG_ra1CoVG4jbUA#/-73.99127/40.74865/11.92"
                                                target="_blank" aria-label="Map feedback" rel="noopener nofollow">Improve
                                                this map</a></div>
                                    </div>
                                </div>
    ...
    <!-- BEGIN: Vendor JS-->
    <script
        src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/vendor/libs/mapbox-gl/mapbox-gl.js">
    </script>
    ...
    <script
        src="https://dash.yekbun.net/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js?id=91a15b5a6abe136b3a259607c4985984">
    </script>
    ...
    <script src="https://dash.yekbun.net/assets/vendor/libs/typeahead-js/typeahead.js?id=70e819040bc904810817c06de6a77130">
    </script>
    ...
    <script
        src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/js/app-logistics-fleet.js">
    </script>
