                                ...
                                <div class="user-avatar-section">
                                    <div class=" d-flex align-items-center flex-column">
                                        <img style="border-radius: 100%;width:50px" class="img-fluid my-2 profile-img"
                                            src="{{ asset('storage/' . $family->user->image) }}"
                                            alt="{{ $family->user->name . ' ' . $family->user->last_name }}">
                                        <div class="user-info text-center">
                                            <p class="mb-2">
                                                <b>{{ $family->user->name . ' ' . $family->user->last_name }}</b>
                                            </p>
                                        ...
                                        {{-- <div class="user-info text-center mt-2">
                                            <h6 style="margin-top:4px" class="mb-2"><b><img height="20px;width:20px"
                                                    ...
                                                    {{ $user->level == 0 ? 'Cultivated' : ($user->level == 1 ? 'Educated' : 'Academic') }}
                                                    User</b></h6>
                                            <h6 class="mb-2">User ID: {{ $family->user->user_id }}</h6>
                                        </div> --}}
                                    </div>
                                </div>
                            </div>
