<form id="editForm{{$ringtone->id}}" method="POST" action="{{ route('settings.storysong.update',$ringtone->id) }}" enctype="multipart/form-data">
    @csrf
    ...
    dropZoneInitFunctions.push(function() {
        ...
        const dropzoneMulti = new Dropzone('#dropzone-audio{{ $ringtone->id }}', {
            ...
            removedfile: function(file) {
                ...
                $.ajax({
                    url: '{{ route('settings.storysong.destroy', $ringtone->id) }}',
                    method: 'delete',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
