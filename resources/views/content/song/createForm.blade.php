<form id="createForm" method="POST" action="{{ route('settings.storysong.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    dropZoneInitFunctions.push(function (){
            ...
            const dropzoneMulti = new Dropzone('#dropzone-audio', {
                ...
                success: function (file, response) {
                    ...
                    hiddenInputsContainer.innerHTML += `<input type="hidden" name="song" value="${response.path}" data-path="${response.path}">`;
