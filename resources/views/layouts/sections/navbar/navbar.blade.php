...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse" style="gap: 4px;">
  ...
  <div class="col-auto card mb-0 px-3 search-wrap d-flex justify-content-center" style="height:54px;">
  ...
  <div class="d-flex align-items-center gap-2">
    @can('channels.read')
    <!-- Channels Column -->
    <div class="card mb-0 d-flex justify-content-center" style="height:54px; min-width: 90px;">
      <ul class="navbar-nav">
    ...
    @can('users.read')
    <!-- Users Column -->
    <div class="card mb-0 d-flex justify-content-center" style="height:54px; min-width: 70px;">
      <ul class="navbar-nav">
    ...
    @can('avatars.read')
    <!-- Avatars Column -->
    <div class="card mb-0 d-flex justify-content-center" style="height:54px; min-width: 85px;">
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle hide-arrow" href="#" data-bs-toggle="dropdown"
            aria-expanded="false">
    ...
    <div class="card mb-0 d-flex justify-content-center" style="height:54px; min-width: 110px;">
      <ul class="navbar-nav">
        <li class="nav-item">
    ...
    <!-- Agents Column -->
    <div class="card mb-0 d-flex justify-content-center" style="height:54px; min-width: 80px;">
      <ul class="navbar-nav">
        <li class="nav-item">
  ...
  <div class="card mb-0 d-flex justify-content-center align-items-center px-2" style="height:54px;">
