...
<div class="navbar-nav-right d-flex align-items-center gap-2" id="navbar-collapse">
  <!-- Search (if horizontal menu is not set) -->
  @if (!isset($menuHorizontal))
  <div class="navbar-search-card">
  ...
  <div class="d-flex align-items-center gap-2 flex-wrap">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="javascript:void(0);" data-bs-toggle="dropdown">
            <div class="d-flex align-items-center gap-2">
              <img src="{{ asset('assets/img/Channels.svg') }}" width="20" height="20" alt="Channels">
    ...
    <div class="navbar-menu-card">
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="javascript:void(0);" data-bs-toggle="dropdown">
            <div class="d-flex align-items-center gap-2">
              <img src="{{ asset('assets/img/Users.svg') }}" width="20" height="20" alt="Users">
    ...
    <!-- Add other permission-based items following the same pattern -->
  </div>

  <!-- Right Side Icons (always visible) -->
  <div class="d-flex align-items-center gap-3 ms-auto">
    <!-- Shortcuts -->
    <div class="navbar-icon-card">
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          <a class="nav-link px-0" href="javascript:void(0);" data-bs-toggle="dropdown">
    ...
    <div class="navbar-icon-card">
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          <a class="nav-link px-0 position-relative" href="javascript:void(0);" data-bs-toggle="dropdown">
            <i class="bx bx-bell bx-sm"></i>
            <span class="position-absolute top-0 start-100 translate-middle badge bg-danger rounded-pill">5</span>
          </a>
