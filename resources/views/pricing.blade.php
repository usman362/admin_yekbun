  ...
  <div class="bs-stepper-content">
          ...
          <div class="col-md-12 container p-3 main-panel">
			...
			<div class="row">
                ...
                <div class="col-md-12 text-center bot-20">
                	<label for="uploadimage"><img id="avatar_image" src="{{asset('/images/uploadimage.png')}}" />	</label>
                            <input required name="dp" id="uploadimage" type="file" onchange="loadFile(event)" class="dropify" data-height="90" accept="image/*" />
        	...
        	<div class="col-md-3">
                ...
                <input required class="form-control mb-3 one" id="title" name="title"  type="text" class="mb-4" placeholder="Price Title...">
            ...
            <div class="col-md-3">
                ...
                <input required class="form-control mb-3 one" id="days" name="days" min="0" type="number" class="mb-4" placeholder="1" value="1" >
            ...
            <div class="col-md-3">
                ...
                <select required class="form-control mb-3 one" id="currency" name="currency"  class="mb-4" >
            ...
            <div class="col-md-3">
                ...
                <input required class="form-control mb-3 one" id="price" name="price" type="text" placeholder="Free" >
        ...
        <div style="padding:15px" class="coloun price-item">
            <div class="d-flex justify-content-between">
                <div class="d-flex justify-content-inline">
                    <img src="{{asset('/images/prices/' . $newprice->image )}}" alt="" width="20px" height="25px">
            ...
            <p class="price_details"><span class="txt-green">&#10003; &nbsp;{{$newprice->days}} days</span>
			 {{$newprice->desription}}
...
-->
		<div class="dots-img">
		<div class="btn show_details" cid="{{$newprice->id}}"  data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" data-bs-original-title="Edit"><i class="bx bx-edit"></i></div>
