...
class ViewsController extends Controller
{
    ...
    {
        $feeds = FeedViews::where('feed_type', $request->feed_type)->where('feed_id', $request->feed_id)->get();
    ...
    {
        $multimedia = FeedViews::where('media_type', $request->media_type)->where('media_id', $request->media_id)->get();
